История tools-types 
-------
Основан: 20 февраля 2021 15:19:37, Картонажником.  
...
**Версия 1.2.7 (предварительная)**  
----------------------------------
[2021y-04m-25d][23:50:00] #74_v127
1) upd: types/sfinae/deref_available   100 PRE
     - upd: test-deref_available

**Версия 1.2.7 (предварительная)**  
----------------------------------
[2021y-04m-24d][23:50:00] #74_v127
1) bug: types/sfinae/sfinae-2010  100 PRE
2) add: types/sfinae/sfinae-2008  100 PRE
     - deref_available          100 PRE

**Версия 1.2.7 (предварительная)**  
----------------------------------
[2021y-04m-23d][23:55:00] #72_v127
1) add: types/sfinae 100 PRE
     add: sfinae-2015  100 PRE (ready)
     add: sfinae-2010  100 PRE (not worked)
     add: sfinae-2008  100 PRE (in progress...)

**Версия 1.2.7 (промежуточная)**  
----------------------------------
[2021y-04m-23d][13:15:50] #71_docs
1) fix docs errors

**Версия 1.2.7 (промежуточная)**  
----------------------------------
[2021y-04m-22d][12:00:00] #69_docs
1) обновлено: тесты traits
2) баг-фикс: array-2008      102 PRE
...
3) исправлен: types/variadic          003 PRE
     - исправлен: variadic-old      003 PRE
     - обновлен:  variadic-new      003 PRE
     - обновлены: тесты
