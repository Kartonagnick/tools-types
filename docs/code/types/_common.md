...
| **ID** |     элементы      |      tools /common/version      | mingw 830,720,710 | msvc 2019,2017,2015 | msvc 2013,2012,2010,2008                |  
|:------:|:-----------------:|:-------------------------------:|:-----------------:|:-------------------:|:---------------------------------------:|  
|  0000  | [degradate][I0]   | 0.2.7 [![P]][M] / 1.0.0 / 1.0.1 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![D]][0] [![D]][0] [![D]][0] |  
|  0001  | [lvalue-2013][I1] | 0.2.7 [![P]][M] / 1.0.0 / 1.0.1 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![N]][0] [![N]][0] [![N]][0] |  
|  0002  | [rvalue-2013][I2] | 0.2.7 [![P]][M] / 1.0.0 / 1.0.1 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![N]][0] [![N]][0] [![N]][0] |  
...
| **ID** | элементы                | tools           |    версия     | mingw 830,720,710 | msvc 2019,2017,2015 | msvc 2013,2012,2010,2008                |  
|:------:|:-----------------------:|:---------------:|:-------------:|:-----------------:|:-------------------:|:---------------------------------------:|  
|  0000  | [is_const_data-2008][M] | 0.2.7 [![P]][M] | 1.0.9 / 1.0.0 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][VS-OLD]                          |  
|  0001  | [is_const_data-2012][M] | 0.2.7 [![P]][M] | 1.0.9 / 1.0.0 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![V]][M] [![N]][7] [![N]][7] |  
|  0002  | [is_const_data-2013][M] | 0.2.7 [![P]][M] | 1.0.9 / 1.0.0 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![N]][7] [![N]][7] [![N]][7] |  

[7]: #-ограничения-is_const_data  "ограничения is_const_data"

[![V]][M] ограничения is_const_data
-------------------------------
...
is_const_data-2008: 
  совместимость со всеми компиляторами.
  использует старый синтаксис.
  использует dTRAIT.
...
| **ID** | элементы             | tools           |    версия     | mingw 830,720,710 | msvc 2019,2017,2015 | msvc 2013,2012,2010,2008                |  
|:------:|:--------------------:|:---------------:|:-------------:|:-----------------:|:-------------------:|:---------------------------------------:|  
|  0000  | [enable_for-2008][M] | 0.2.7 [![P]][M] | 1.0.9 / 1.0.0 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][VS-OLD]                          |  
|  0001  | [enable_for-2012][M] | 0.2.7 [![P]][M] | 1.0.9 / 1.0.0 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![V]][M] [![N]][8] [![N]][8] |  
|  0002  | [enable_for-2013][M] | 0.2.7 [![P]][M] | 1.0.9 / 1.0.0 |   [![V]][MINGW]   |   [![V]][VS-NEW]    | [![V]][M] [![N]][8] [![N]][8] [![N]][8] |  

[8]: #-ограничения-enable_for  "ограничения enable_for"

[![V]][M] ограничения enable_for
-------------------------------
