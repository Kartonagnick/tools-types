...
TEST_COMPONENT(000)
{
    ...
    dTEST_RVAL(const char&&   , char   );
    dTEST_RVAL(volatile char&&, char   );
}
...
//------------------------------------------------------------------------------
    dTEST_RVAL(char* const&&                        , char*                );
    dTEST_RVAL(const char* const&&                  , const char*          );
    dTEST_RVAL(volatile char* const&&               , volatile char*       );
    dTEST_RVAL(volatile const char* const&&         , volatile const char* );
//------------------------------------------------------------------------------
    dTEST_RVAL(char* volatile&&                     , char*                );
    dTEST_RVAL(const char* volatile&&               , const char*          );
    dTEST_RVAL(volatile char* volatile&&            , volatile char*       );
    dTEST_RVAL(volatile const char* volatile&&      , volatile const char* );
//------------------------------------------------------------------------------
    dTEST_RVAL(char* volatile const&&               , char*                );
    dTEST_RVAL(const char* volatile const&&         , const char*          );
    dTEST_RVAL(volatile char* volatile const&&      , volatile char*       );
    dTEST_RVAL(volatile const char* volatile const&&, volatile const char* );
}
...
TEST_COMPONENT(003)
{
    ...
    dTEST_RVAL(char* const** const&&            , char* const**             );
    dTEST_RVAL(char*** const* const** const&&   , char*** const* const**    );
    dTEST_RVAL(char*** volatile* const** const&&, char*** volatile* const** );
    dTEST_RVAL(char*** const* volatile** const&&, char*** const* volatile** );
}
...
//------------------------------------------------------------------------------
    ...
    dTEST_RVAL(volatile char* const(* volatile* volatile&&)[1][2][3], volatile char* const(* volatile*)[1][2][3] );
...
TEST_COMPONENT(008)
{
    ...
    dTEST_RVAL(int(*&&)()               , int(*)() );
    dTEST_RVAL(int(* const&&)()         , int(*)() );
    dTEST_RVAL(int(* volatile&&)()      , int(*)() );
    dTEST_RVAL(int(* volatile const&&)(), int(*)() );
}
...
TEST_COMPONENT(011)
{
    ...
    dTEST_RVAL(int(some::* const&&)()         , int(some::*)() );
    dTEST_RVAL(int(some::* volatile&&)()      , int(some::*)() );
    dTEST_RVAL(int(some::* volatile const&&)(), int(some::*)() );
}
...
//------------------------------------------------------------------------------
    ...
    dTEST_TRUE(const int some::* const&                   , const int some::* );
    dTEST_RVAL(const int some::* const&&                  , const int some::* );

    dTEST_TRUE(const int some::* volatile                 , const int some::* );
    dTEST_TRUE(const int some::* volatile&                , const int some::* );
    dTEST_RVAL(const int some::* volatile&&               , const int some::* );

    dTEST_TRUE(const int some::* volatile const           , const int some::* );
    dTEST_TRUE(const int some::* volatile const&          , const int some::* );
    dTEST_RVAL(const int some::* volatile const&&         , const int some::* );
//------------------------------------------------------------------------------
    ...
    dTEST_TRUE(volatile int some::* const&                , volatile int some::* );
    dTEST_RVAL(volatile int some::* const&&               , volatile int some::* );
                                                                                 
    dTEST_TRUE(volatile int some::* volatile              , volatile int some::* );
    dTEST_TRUE(volatile int some::* volatile&             , volatile int some::* );
    dTEST_RVAL(volatile int some::* volatile&&            , volatile int some::* );
                                                                                 
    dTEST_TRUE(volatile int some::* volatile const        , volatile int some::* );
    dTEST_TRUE(volatile int some::* volatile const&       , volatile int some::* );
    dTEST_RVAL(volatile int some::* volatile const&&      , volatile int some::* );
//------------------------------------------------------------------------------
    ...
    dTEST_TRUE(volatile const int some::* const&          , volatile const int some::* );
    dTEST_RVAL(volatile const int some::* const&&         , volatile const int some::* );
                                                                                       
    dTEST_TRUE(volatile const int some::* volatile        , volatile const int some::* );
    dTEST_TRUE(volatile const int some::* volatile&       , volatile const int some::* );
    dTEST_RVAL(volatile const int some::* volatile&&      , volatile const int some::* );
                                                                                       
    dTEST_TRUE(volatile const int some::* volatile const  , volatile const int some::* );
    dTEST_TRUE(volatile const int some::* volatile const& , volatile const int some::* );
    dTEST_RVAL(volatile const int some::* volatile const&&, volatile const int some::* );
}
